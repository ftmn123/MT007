...
if (process.env.COOKIE_NAME30 && process.env.COOKIE_NAME_EN ) {
  cookie_name[30] = process.env.COOKIE_NAME31;num = 30;
}
/* //for test
if (!process.env.COOKIE_NAME12 && !process.env.COOKIE_NAME_EN ) {
 cookie_name[11] = "小平11号";num = 12;
}
cookie_name[0] = "小平1号";
cookie_name[1] = "小平2号";
cookie_name[2] = "小平3号";
 ...
 * @returns {Promise<unknown>}
 */
const name_num1 = ['账号1', '账号2','账号3','账号4','账号5','账号6','账号7','账号8','账号9','账号10','账号11','账号12','账号13','账号14','账号15','账号16','账号17','账号18','账号19','账号20','账号21','账号22','账号23','账号24','账号25','账号26','账号27','账号28','账号29','账号30',];
const name_num2 = ['东号1', '东号2','东号3','东号4','东号5','东号6','东号7','东号8','东号9','东号10','东号11','东号12','东号13','东号14','东号15','东号16','东号17','东号18','东号19','东号20','东号21','东号22','东号23','东号24','东号25','东号26','东号27','东号28','东号29','东号30',];
const name_num3 = ['号 1', '号 2','号 3','号 4','号 5','号 6','号 7','号 8','号 9','号 10','号 11','号 12','号 13','号 14','号 15','号 16','号 17','号 18','号 19','号 20','号 21','号 22','号 23','号 24','号 25','号 26','号 27','号 28','号 29','号 30',];
...
async function sendNotify(text, desp, params = {}, author = '\n\n仅供用于学习') {
  ...
  //添加了自定义名称，对应config文件中的COOKIE_NAME1-30
    ...
    for ( let i = num;i >= 0; i--) {
      if (desp.includes(name_num1[i])) {
        desp = desp.replace(new RegExp(name_num1[i], "gm"), "账号：【" + cookie_name[i] + "】");
        text = text.replace(new RegExp(name_num1[i], "gm"), "账号：【" + cookie_name[i] + "】");
 //       console.log(`\n ========================成功替换${i}==================================\n`);
 //       console.log(`\n ========================成功替换${name_num1[i]}==================================\n`);
  //      console.log(`\n ==============================${desp}===========================================\n`);
      }
      else if (desp.includes(name_num2[i])) {
        desp = desp.replace(new RegExp(name_num2[i], "gm"), "账号：【" + cookie_name[i] + "】");
        text = text.replace(new RegExp(name_num2[i], "gm"), "账号：【" + cookie_name[i] + "】");
 //       console.log(`\n ========================成功替换${i}==================================\n`);
  //      console.log(`\n ========================成功替换${name_num1[i]}==================================\n`);
  //      console.log(`\n ==============================${desp}===========================================\n`);
      }
      else if (desp.includes(name_num3[i])) {
        desp = desp.replace(new RegExp(name_num3[i], "gm"), "账号：【" + cookie_name[i] + "】");
        text = text.replace(new RegExp(name_num3[i], "gm"), "账号：【" + cookie_name[i] + "】");
        //       console.log(`\n ========================成功替换${i}==================================\n`);
        //      console.log(`\n ========================成功替换${name_num1[i]}==================================\n`);
        //      console.log(`\n ==============================${desp}===========================================\n`);
      }
...
desp  = desp.replace(new RegExp("京东","gm"), "X东" );//全部京东都改成X东
  console.log(`\n <<<<<<<<<<<<<<完整推送消息>>>>>>>>>>>>>>\n`);
  console.log(`\n <<<<<<<<<<<<<<${desp}>>>>>>>>>>>>>>\n`);
